...
const snippet2 = `export default function Carousel({ items }) {
        ...
        <article className={projectPageStyles.projectContent}>
          <section className={projectPageStyles.snippet}>
            ...
            <pre className={projectPageStyles.code}>
              <code className="language-jsx">{snippet1}</code>
            </pre>
          </section>
          ...
          <section className={projectPageStyles.snippet}>
            ...
            <pre className={projectPageStyles.code}>
              <code className="language-jsx">{snippet2}</code>
            </pre>
          </section>
          ...
          <section className={projectPageStyles.snippet}>
            ...
            <pre className={projectPageStyles.code}>
              <code className="language-css">{snippet3}</code>
            </pre>
          </section>
        </article>
      </main>
